...
<script type="text/javascript">
	...
	layui.config({base:'/layui.extend/modules/information/'}).use('info_partyHisConsider', function(){
	
		var info_partyHisConsider = layui.info_partyHisConsider; info_partyHisConsider();
