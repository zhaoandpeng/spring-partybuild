...
<script type="text/javascript">
	...
	layui.config({base:'/layui.extend/modules/information/'}).use('info_partyStyleGover', function(){
	
		var info_partyStyleGover = layui.info_partyStyleGover; info_partyStyleGover();
