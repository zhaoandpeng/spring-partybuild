...
<script type="text/javascript">
	...
	layui.config({base:'/layui.extend/modules/information/'}).use('info_leagueFlagFloat', function(){
	
		var info_leagueFlagFloat = layui.info_leagueFlagFloat; info_leagueFlagFloat();
