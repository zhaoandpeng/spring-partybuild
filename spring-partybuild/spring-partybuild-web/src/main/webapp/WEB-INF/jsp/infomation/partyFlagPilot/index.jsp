...
<script type="text/javascript">
	...
	layui.config({base:'/layui.extend/modules/information/'}).use('info_partyFlagPilot', function(){
	
		var info_partyFlagPilot = layui.info_partyFlagPilot; info_partyFlagPilot();
