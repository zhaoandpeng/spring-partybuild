...
<script type="text/javascript">
	...
	layui.config({base:'/layui.extend/modules/information/'}).use('info_partyBuildNews', function(){
	
		var info_partyBuildNews = layui.info_partyBuildNews; info_partyBuildNews();
