...
public class PartyBuildNewsController extends BaseController{
	...
	public String ajaxGetList() {
		...
		page = informNoticeService.getListPageByParam(status, nodeId, "6", page);
	...
	public String add_or_update() throws SQLException {
		...
		global = informNoticeService.busihandle(id,title,articleSource,createTime,content,read, "6", getCurrentBaseUser());
