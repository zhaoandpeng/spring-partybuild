 ...
 */
@Controller
@RequestMapping("/api/v1/information/partyMember")
public class PartyMemberController extends BaseController{
	...
	public String index() {
		...
		return "infomation/partyMember/index";
	}
	...
	public String ajaxGetList() {
		...
		page = informNoticeService.getListPageByParam(status, nodeId, "8", page);
	...
	public String add_or_update() throws SQLException {
		...
		global = informNoticeService.busihandle(id,title,articleSource,createTime,content,read, "8", getCurrentBaseUser());
