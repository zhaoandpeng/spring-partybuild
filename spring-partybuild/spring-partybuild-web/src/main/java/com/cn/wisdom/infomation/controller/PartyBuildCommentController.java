...
public class PartyBuildCommentController extends BaseController{
	...
	public String ajaxGetList() {
		...
		page = informNoticeService.getListPageByParam(status, nodeId, "10", page);
	...
	public String add_or_update() throws SQLException {
		...
		global = informNoticeService.busihandle(id,title,articleSource,createTime,content,read, "10", getCurrentBaseUser());
